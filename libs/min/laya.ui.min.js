!(function (t, e) {
  ...
  class h extends e.Graphics {
    ...
    _createDrawTexture(
      ...
      if (!t || l < 0.01) return null;
      if (!t.getIsReady()) return null;
      if (
        (h || (h = t.sourceWidth), a || (a = t.sourceHeight), t.getIsReady())
      ) {
        var c = h / t.sourceWidth,
          d = a / t.sourceHeight;
        if (((h = t.width * c), (a = t.height * d), h <= 0 || a <= 0))
          return null;
        (s += t.offsetX * c), (i += t.offsetY * d);
      }
      return (
        this._sp &&
          ((this._sp._renderType |= e.SpriteConst.GRAPHICS),
    ...
    drawBitmap(t, e, s, i, h = 0, a = 0) {
      h < 0.1 ||
        a < 0.1 ||
        (!t || (e.width == h && e.height == a)
          ? this.drawImage(e, s, i, h, a)
          : this.fillTexture(e, s, i, h, a));
    }
    static getTexture(t, s, i, h, a) {
      ...
      return (
        ...
        (r && r._getSource()) ||
          (r = e.Texture.createFromTexture(t, s, i, h, a)),
        r
      );
    }
    _setDrawGridCmd(t) {
      ...
      if (this._one || (s && !(s.length <= 0))) {
        ...
        e
          ? e == this._drawGridCmd
            ? (this._one = t)
            : (this.clear(), this._saveToCmd(null, t), this._saveToCmd(null, e))
          : s.splice(0, 0, t);
  ...
  class a extends e.Component {
    ...
    _onEnable() {
      this.owner.parent
        ? this._onAdded()
        : this.owner.once(e.Event.ADDED, this, this._onAdded);
    }
    _onDisable() {
    ...
    _onAdded() {
      this.owner.parent &&
        this.owner.parent.on(e.Event.RESIZE, this, this._onParentResize),
        this.resetLayoutX(),
        this.resetLayoutY();
    }
    _onParentResize() {
      ...
      if (e)
        if (isNaN(this.centerX)) {
          if (isNaN(this.left))
            isNaN(this.right) ||
              (t.x = Math.round(
                e.width - t.displayWidth - this.right + t.pivotX * t.scaleX
              ));
          else if (
            ...
            var s = (e._width - this.left - this.right) / (t.scaleX || 0.01);
            if (s != t.width) return (t.width = s), !0;
          }
        } else
          t.x = Math.round(
            0.5 * (e.width - t.displayWidth) +
              this.centerX +
              t.pivotX * t.scaleX
          );
      return !1;
      ...
      if (e)
        if (isNaN(this.centerY)) {
          if (isNaN(this.top))
            isNaN(this.bottom) ||
              (t.y = Math.round(
                e.height - t.displayHeight - this.bottom + t.pivotY * t.scaleY
              ));
          else if (
            ...
            var s = (e._height - this.top - this.bottom) / (t.scaleY || 0.01);
            if (s != t.height) return (t.height = s), !0;
          }
        } else
          t.y = Math.round(
            0.5 * (e.height - t.displayHeight) +
              this.centerY +
              t.pivotY * t.scaleY
          );
      return !1;
  ...
  class l {
    static fillArray(t, e, s = null) {
      ...
      if (e)
        for (
          var h = e.split(","), a = 0, r = Math.min(i.length, h.length);
          a < r;
          a++
        ) {
          var l = h[a];
  ...
  class n extends e.Sprite {
    ...
    set_scaleX(t) {
      super.get_scaleX() != t &&
        (super.set_scaleX(t), this.callLater(this._sizeChanged));
    }
    get scaleX() {
      return super.scaleX;
    }
    ...
    set_scaleY(t) {
      super.get_scaleY() != t &&
        (super.set_scaleY(t), this.callLater(this._sizeChanged));
    }
    get scaleY() {
      return super.scaleY;
    }
    ...
    set_anchorX(t) {
      this._anchorX != t &&
        ((this._anchorX = t), this.callLater(this._sizeChanged));
    }
    get anchorY() {
    ...
    set_anchorY(t) {
      this._anchorY != t &&
        ((this._anchorY = t), this.callLater(this._sizeChanged));
    }
  ...
  class o extends n {
    ...
    set skin(t) {
      if (this._skin != t)
        if (((this._skin = t), t)) {
          ...
          s
            ? ((this.source = s), this.onCompResize())
            : e.ILaya.loader.load(
                this._skin,
                e.Handler.create(this, this.setSource, [this._skin]),
                null,
                e.Loader.IMAGE,
                1,
                !0,
    ...
    set source(t) {
      this._bitmap &&
        ((this._bitmap.source = t), this.event(e.Event.LOADED), this.repaint());
    }
    get group() {
      return this._group;
    }
  ...
  class _ extends o {
    ...
    init() {
      this.isSupportJump()
        ? ((e.Browser.onMiniGame || e.Browser.onBDMiniGame) &&
            e.ILaya.timer.loop(
              this._resquestTime,
              this,
    ...
    revertAdvsData() {
      this.advsListArr[this._playIndex] &&
        ((this.visible = !0), (this.skin = this.advsListArr[this._playIndex]));
    }
    isSupportJump() {
      return e.Browser.onMiniGame
        ? window.wx.navigateToMiniProgram instanceof Function
    ...
    onLunbo() {
      this._playIndex >= this.advsListArr.length - 1
        ? (this._playIndex = 0)
        : (this._playIndex += 1),
        (this.visible = !0),
        this.revertAdvsData();
  ...
  class c extends n {
    ...
    set bgColor(t) {
      (this._bgColor = t),
        t
          ? (this._onResize(null),
            this.on(e.Event.RESIZE, this, this._onResize))
          : (this.graphics.clear(),
  ...
  class d extends n {
    ...
    initialize() {
      1 !== this._mouseState &&
        ((this.mouseEnabled = !0), this._setBit(e.Const.HAS_MOUSE, !0)),
    ...
    onMouse(t) {
      if (!1 !== this.toggle || !this._selected)
        return t.type === e.Event.CLICK
          ? (this.toggle && (this.selected = !this._selected),
            void (this._clickHandler && this._clickHandler.run()))
          : void (!this._selected && (this.state = d.stateMap[t.type]));
    }
    get skin() {
      return this._skin;
    }
      ...
      this._skin != t &&
        ...
        t
          ? e.Loader.getRes(t)
            ...
            : e.ILaya.loader.load(
                this._skin,
                e.Handler.create(this, this._skinLoaded),
                null,
                e.Loader.IMAGE,
                1
              )
        ...
        if ((e.Utils.isOkTextureList(a) || (a = null), a)) this._sources = a;
          ...
          if (((this._sources = []), 1 === this._stateNum))
            ...
            for (var r = 0; r < this._stateNum; r++)
              this._sources.push(
                e.Texture.createFromTexture(t, 0, i * r, s, i)
              );
          e.WeakObject.I.set(h, this._sources);
        }
        this._autoSize
          ? ((this._bitmap.width = this._width || s),
            (this._bitmap.height = this._height || i),
            this._text &&
              ((this._text.width = this._bitmap.width),
              (this._text.height = this._bitmap.height)))
          : this._text && (this._text.x = s);
    ...
    set height(t) {
      super.set_height(t),
        this._autoSize &&
          ((this._bitmap.height = t), this._text && (this._text.height = t));
    }
    get height() {
  ...
  (d.stateMap = { mouseup: 0, mouseover: 1, mousedown: 2, mouseout: 0 }),
    e.ILaya.regClass(d),
  ...
  class g extends n {
    ...
    _onDisplay(t) {
      this._isPlaying
        ? this._getBit(e.Const.DISPLAYED_INSTAGE)
          ? this.play()
          : this.stop()
        ...
        if ((e.Utils.isOkTextureList(r) || (r = null), r)) this._sources = r;
          ...
          for (var l = 0; l < this._clipY; l++)
            for (var n = 0; n < this._clipX; n++)
              this._sources.push(
                e.Texture.createFromTexture(s, i * n, h * l, i, h)
              );
  ...
  class m extends n {
    ...
    set skin(t) {
      this._skin != t &&
        ((this._skin = t),
        this._skin && !e.Loader.getRes(this._skin)
          ? e.ILaya.loader.load(
              [this._skin, this._skin.replace(".png", "$bar.png")],
              e.Handler.create(this, this._skinLoaded)
            )
          : this._skinLoaded());
    }
    _skinLoaded() {
      ...
      e.Loader.getRes(t) &&
        (this._progress ||
          (this.addChild((this._progress = new o())),
  ...
  class v extends n {
    ...
    onStageMouseUp2(t) {
      if (
        ...
        if (((this._target.mouseEnabled = !0), this._isElastic)) {
          ...
          for (
            var i = 0, h = Math.min(this._offsets.length, 3), a = 0;
            a < h;
            a++
          )
    ...
    elasticOver() {
      (this._isElastic = !1),
        !this.hide && this.autoHide && e.Tween.to(this, { alpha: 0 }, 500),
        this.event(e.Event.END);
    }
    tweenMove(t) {
      var s;
  ...
  class b extends c {
    ...
    changeCells() {
      if (((this._cellChanged = !1), this._itemRender)) {
        ...
        (this._cellSize = this._isVertical ? s : e),
          ...
          this._isVertical && this.vScrollBarSkin
    ...
    _createItems(t, e, s) {
      ...
      for (var d = t; d < s; d++)
        for (var u = 0; u < e; u++)
          ((h = n && n.length ? n.pop() : this.createItem()).x =
            (this._isVertical ? u : d) * a - i._x),
    ...
    setContentSize(t, s) {
      (this._content.width = t),
        ...
        (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) &&
          (this._content._style.scrollRect ||
            (this._content.scrollRect = e.Rectangle.create()),
          this._content._style.scrollRect.setTo(
            -this._offset.x,
            -this._offset.y,
            t,
            s
    ...
    onScrollBarChange(t = null) {
      ...
      if (this.cacheContent)
        (r = i + 1),
          this._createdLine - h < r &&
            (this._createItems(this._createdLine, s, this._createdLine + r),
    ...
    addItem(t, e = !0) {
      ...
      if (
        ...
        "horizontal" == this._direction
          ? (s.x = h._x + h.width + this._space)
          : (s.y = h._y + h.height + this._space);
      } else e && ((s.x = 0), (s.y = 0));
      return i;
    }
    delItem(t, e = !0) {
      ...
      if (-1 != s) {
        ...
        for (var a = s + 1, r = this._items.length; a < r; a++) {
          ...
          (l.name = "item" + (a - 1)),
            e &&
              ("horizontal" == this._direction
                ? (l.x -= h.width + this._space)
                : (l.y -= h.height + this._space));
        }
    ...
    set labels(t) {
      if (this._labels != t) {
        if (
          ...
          for (
            var e = this._labels.split(","), s = 0, i = e.length;
            s < i;
            s++
          ) {
  ...
  class k extends C {
    ...
    set text(t) {
      this._tf.text != t &&
        ((t += ""), (this._tf.text = t), this.event(e.Event.CHANGE));
    }
    get text() {
      return super.text;
    }
  ...
  class M extends k {
    ...
    set vScrollBarSkin(t) {
      null == this._vScrollBar &&
        (this.addChild((this._vScrollBar = new f())),
    ...
    set hScrollBarSkin(t) {
      null == this._hScrollBar &&
        (this.addChild((this._hScrollBar = new S())),
    ...
    changeScroll() {
      ...
      t && (s = this._vScrollBar.width),
        ...
        this._vScrollBar &&
          ((this._vScrollBar.x = this._width - this._vScrollBar.width - a[1]),
          (this._vScrollBar.y = a[0]),
          (this._vScrollBar.height = this._height - h - a[0] - a[2]),
          (this._vScrollBar.scrollSize = 1),
          (this._vScrollBar.thumbPercent =
            this._tf.height / Math.max(this._tf.textHeight, this._tf.height)),
          this._vScrollBar.setScroll(
            0,
            this._tf.maxScrollY + 5,
            this._tf.scrollY
          ),
          (this._vScrollBar.visible = t)),
        this._hScrollBar &&
          ((this._hScrollBar.x = a[3]),
          (this._hScrollBar.y = this._height - this._hScrollBar.height - a[2]),
          (this._hScrollBar.width = this._width - s - a[1] - a[3]),
          (this._hScrollBar.scrollSize = Math.max(0.033 * this._tf.width, 1)),
          (this._hScrollBar.thumbPercent =
            this._tf.width / Math.max(this._tf.textWidth, this._tf.width)),
          this._hScrollBar.setScroll(
            0,
            this._tf.maxScrollX + a[1] + a[3] + 8,
            this._tf.scrollX
          ),
  ...
  class z extends c {
    ...
    set vScrollBarSkin(t) {
      null == this._vScrollBar &&
        (super.addChild((this._vScrollBar = new f())),
        this._vScrollBar.on(e.Event.CHANGE, this, this.onScrollBarChange, [
          this._vScrollBar,
        ]),
    ...
    set hScrollBarSkin(t) {
      null == this._hScrollBar &&
        (super.addChild((this._hScrollBar = new S())),
        this._hScrollBar.on(e.Event.CHANGE, this, this.onScrollBarChange, [
          this._hScrollBar,
        ]),
  ...
  class A extends D {
    ...
    set height(t) {
      this._height != t &&
        ((super.height = t), this.callLater(this.changeItems));
    }
    get height() {
      return super.height;
    }
    ...
    changeItems() {
      ...
      for (s = 0, i = t.length; s < i; s++)
        (h = t[s]),
          ...
          this._align == N.LEFT
            ? (h.x = 0)
            : this._align == N.CENTER
            ? (h.x = 0.5 * (e - h.width * h.scaleX))
            : this._align == N.RIGHT && (h.x = e - h.width * h.scaleX),
  ...
  class P extends g {
    ...
    changeValue() {
      ...
      if (
        this._sources &&
        this._valueArr &&
        (this.graphics.clear(!0), (t = this._sources[0]))
      ) {
  ...
  class Y extends e.Scene {
    ...
    static __init__() {
      e.ILaya.ClassUtils.regShortClassName([
        B,
        d,
        M,
        p,
  ...
  class R extends e.Sprite {
    ...
    open(t, s = !1, i = !1) {
      s && this._closeAll(),
        ...
        this.addChild(t),
        (t.isModal || this._getBit(e.Const.HAS_ZORDER)) &&
  ...
  class V extends n {
    ...
    onEnable() {
      this.postMsg({ type: "display", rate: e.Laya.stage.frameRate }),
        window.wx &&
          window.sharedCanvas &&
          e.Laya.timer.frameLoop(1, this, this._onLoop);
    }
    onDisable() {
    ...
    _postMsg() {
      ...
      var s = e.Laya.stage;
      t.scale(
        s._canvasTransform.getScaleX() *
          this.globalScaleX *
          s.transform.getScaleX(),
        s._canvasTransform.getScaleY() *
          this.globalScaleY *
          s.transform.getScaleY()
      ),
        this.postMsg({
          type: "changeMatrix",
          a: t.a,
