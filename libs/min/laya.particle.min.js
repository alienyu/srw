!(function (t, e) {
  ...
  class a {
    ...
    static Create(t, i, r, s) {
      var n = new a();
      (n.position = i),
        e.MathUtil.scaleVector3(
          r,
          t.emitterVelocitySensitivity,
          a._tempVelocity
        );
      var o,
        l = e.MathUtil.lerp(
          t.minHorizontalVelocity,
          t.maxHorizontalVelocity,
          Math.random()
        ),
        h = Math.random() * Math.PI * 2;
      if (
        ((a._tempVelocity[0] += l * Math.cos(h)),
        (a._tempVelocity[2] += l * Math.sin(h)),
        (a._tempVelocity[1] += e.MathUtil.lerp(
          t.minVerticalVelocity,
          t.maxVerticalVelocity,
          Math.random()
        )),
        (n.velocity = a._tempVelocity),
        (n.startColor = a._tempStartColor),
        (n.endColor = a._tempEndColor),
        t.disableColor)
      ) {
        for (o = 0; o < 3; o++) (n.startColor[o] = 1), (n.endColor[o] = 1);
        (n.startColor[o] = e.MathUtil.lerp(
          t.minStartColor[o],
          t.maxStartColor[o],
          Math.random()
        )),
          (n.endColor[o] = e.MathUtil.lerp(
            t.minEndColor[o],
            t.maxEndColor[o],
            Math.random()
          ));
      ...
      var m = Math.random();
      (n.sizeRotation[0] = e.MathUtil.lerp(t.minStartSize, t.maxStartSize, m)),
        (n.sizeRotation[1] = e.MathUtil.lerp(t.minEndSize, t.maxEndSize, m)),
        (n.sizeRotation[2] = e.MathUtil.lerp(
          t.minRotateSpeed,
          t.maxRotateSpeed,
          Math.random()
        )),
      ...
      var d = Math.random();
      (n.radius[0] = e.MathUtil.lerp(t.minStartRadius, t.maxStartRadius, d)),
        (n.radius[1] = e.MathUtil.lerp(t.minEndRadius, t.maxEndRadius, d)),
        (n.radian = a._tempRadian),
        (n.radian[0] = e.MathUtil.lerp(
          t.minHorizontalStartRadian,
          t.maxHorizontalStartRadian,
          Math.random()
        )),
        (n.radian[1] = e.MathUtil.lerp(
          t.minVerticalStartRadian,
          t.maxVerticalStartRadian,
          Math.random()
        ));
      ...
      return (
        (n.radian[2] = c
          ? e.MathUtil.lerp(
              t.minHorizontalEndRadian,
              t.maxHorizontalEndRadian,
              Math.random()
            )
          : n.radian[0]),
        (n.radian[3] = c
          ? e.MathUtil.lerp(
              t.minVerticalEndRadian,
              t.maxVerticalEndRadian,
              Math.random()
            )
          : n.radian[1]),
        (n.durationAddScale = t.ageAddScale * Math.random()),
        (n.time = s),
        n
      );
    }
  }
  (a._tempVelocity = new Float32Array(3)),
    (a._tempStartColor = new Float32Array(4)),
    (a._tempEndColor = new Float32Array(4)),
    (a._tempSizeRotation = new Float32Array(3)),
    (a._tempRadius = new Float32Array(2)),
    (a._tempRadian = new Float32Array(4));
  class s extends r {
    constructor(t) {
      super(),
    ...
    freeRetiredParticles() {
      for (; this._firstRetiredElement != this._firstActiveElement; ) {
        if (
          this._drawCounter -
            this._vertices[
              this._firstRetiredElement * this._floatCountPerVertex * 4 + 28
            ] <
          3
        )
          break;
    ...
    addParticleArray(t, e) {
      ...
      if (
        ...
        for (
          var r = a.Create(this.settings, t, e, this._currentTime),
            s = this._firstFreeElement * this._floatCountPerVertex * 4,
            n = 0;
          n < 4;
          n++
        ) {
          var o, l;
          for (o = 0, l = 4; o < 3; o++)
            this._vertices[s + n * this._floatCountPerVertex + l + o] =
              r.position[o];
          for (o = 0, l = 7; o < 3; o++)
            this._vertices[s + n * this._floatCountPerVertex + l + o] =
              r.velocity[o];
          ...
          for (o = 0, l = 23; o < 4; o++)
            this._vertices[s + n * this._floatCountPerVertex + l + o] =
              r.radian[o];
          (this._vertices[s + n * this._floatCountPerVertex + 27] =
            r.durationAddScale),
            (this._vertices[s + n * this._floatCountPerVertex + 28] = r.time);
        }
  ...
  class h extends e.Value2D {
    ...
    upload() {
      var t = this.size;
      (t[0] = e.RenderState2D.width),
        (t[1] = e.RenderState2D.height),
        (this.alpha = this.ALPHA * e.RenderState2D.worldAlpha),
  ...
  class m extends s {
    constructor(t) {
      ...
      e.ILaya.loader.load(
        ...
        e.Handler.create(null, function (t) {
          i.texture = t;
        }),
        null,
        e.Loader.IMAGE
        ...
        (this._blendFn = e.BlendMode.fns[t.blendState]),
        (this._mesh = e.MeshParticle2D.getAMesh(this.settings.maxPartices)),
        this.initialize();
    }
    getRenderType() {
      return -111;
    ...
    addNewParticlesToVertexBuffer() {
      var t,
        e = this._mesh._vb;
      e.clear(),
        e.append(this._vertices),
        this._firstNewElement < this._firstFreeElement
          ? ((t = 4 * this._firstNewElement * this._floatCountPerVertex * 4),
            e.subUpload(
              t,
              t,
              t +
    ...
    renderSubmit() {
      if (this.texture && this.texture.getIsReady()) {
        if (
          (this.update(e.ILaya.timer._delta),
          ...
          this._mesh.useMesh(t),
            ...
            this._firstActiveElement < this._firstFreeElement
              ...
              : (e.WebGLContext.mainContext.drawElements(
                  t.TRIANGLES,
                  6 * (this.settings.maxPartices - this._firstActiveElement),
                  t.UNSIGNED_SHORT,
                  6 * this._firstActiveElement * 2
                ),
                this._firstFreeElement > 0 &&
    ...
    blend() {
      if (e.BlendMode.activeBlendFunction !== this._blendFn) {
        ...
        t.enable(t.BLEND),
          this._blendFn(t),
          (e.BlendMode.activeBlendFunction = this._blendFn);
      }
    }
    dispose() {
  ...
  class d {
    ...
    set emissionRate(t) {
      t <= 0 ||
        ((this._emissionRate = t), t > 0 && (this.minEmissionTime = 1 / t));
    }
    get emissionRate() {
    ...
    advanceTime(t = 1) {
      if (
        ...
        !(
          this._emissionTime < 0 ||
          ((this._frameTime += t), this._frameTime < this.minEmissionTime)
        ))
      )
  ...
  class c extends d {
    ...
    set template(t) {
      (this._particleTemplate = t),
        ...
        this._particleTemplate instanceof m && (this._emitFun = this.webGLEmit);
    }
    get template() {
  ...
  class _ extends e.Sprite {
    constructor(t) {
      super(),
        (this._matrix4 = new Float32Array([
    ...
    load(t) {
      e.ILaya.loader.load(
        t,
        e.Handler.create(this, this.setParticleSetting),
        null,
        e.ILaya.Loader.JSON
      );
    }
    setParticleSetting(t) {
      ...
      i.checkSetting(t),
        (this.customRenderEnable = !0),
        (this._particleTemplate = new m(t)),
        this.graphics._saveToCmd(
          null,
          e.DrawParticleCmd.create(this._particleTemplate)
        ),
        this._emitter
          ? (this._emitter.template = this._particleTemplate)
          : (this._emitter = new c(this._particleTemplate)),
    ...
    customRender(t, e, i) {
      ((this._matrix4[0] = t._curMat.a),
      (this._matrix4[1] = t._curMat.b),
      (this._matrix4[4] = t._curMat.c),
      (this._matrix4[5] = t._curMat.d),
      (this._matrix4[12] = t._curMat.tx),
      (this._matrix4[13] = t._curMat.ty),
    ...
    destroy(t = !0) {
      this._particleTemplate instanceof m && this._particleTemplate.dispose(),
        super.destroy(t);
    }
  }
  e.ClassUtils.regClass("laya.particle.Particle2D", _),
    e.ClassUtils.regClass("Laya.Particle2D", _),
    e.ILaya.regClass(_);
  (t.Emitter2D = c),
    (t.EmitterBase = d),
    (t.Particle2D = _),
    (t.ParticleData = a),
    (t.ParticleEmitter = class {
      constructor(t, e, i) {
      ...
      update(t, i) {
        if ((t /= 1e3) > 0) {
          ...
          for (
            var r = this._timeLeftOver + t, a = -this._timeLeftOver;
            r > this._timeBetweenParticles;

          )
            (a += this._timeBetweenParticles),
              (r -= this._timeBetweenParticles),
              e.MathUtil.lerpVector3(
                this._previousPosition,
                i,
                a / t,
                this._tempPosition
        ...
        (this._previousPosition[0] = i[0]),
          (this._previousPosition[1] = i[1]),
          (this._previousPosition[2] = i[2]);
      }
    }),
    (t.ParticleSetting = i),
    (t.ParticleShader = l),
    (t.ParticleShaderValue = h),
    (t.ParticleTemplate2D = m),
    (t.ParticleTemplateBase = r),
    (t.ParticleTemplateWebGL = s);
