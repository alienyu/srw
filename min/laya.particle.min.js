!function(t, e) {
    ...
    class i {
        ...
        static checkSetting(t) {
            ...
            for (e in i._defaultSetting)
                e in t || (t[e] = i._defaultSetting[e]);
    ...
    class a {
        ...
        static Create(t, i, r, s) {
            ...
            t.disableColor) {
                ...
                e.MathUtil.lerpVector4(t.minStartColor, t.maxStartColor, Math.random(), n.startColor),
            ...
            n.radian[0] = e.MathUtil.lerp(t.minHorizontalStartRadian, t.maxHorizontalStartRadian, Math.random()),
    ...
    class s extends r {
        ...
        retireActiveParticles() {
            for (var t = this.settings.duration; this._firstActiveElement != this._firstNewElement; ) {
                ...
                if ((r *= 1 + this._vertices[e + 27]) + 1e-4 < t)
                    break;
        ...
        addParticleArray(t, e) {
            ...
            i !== this._firstRetiredElement) {
                for (var r = a.Create(this.settings, t, e, this._currentTime), s = this._firstFreeElement * this._floatCountPerVertex * 4, n = 0; n < 4; n++) {
                    ...
                    for (o = 0,
                    l = 4; o < 3; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.position[o];
                    for (o = 0,
                    l = 7; o < 3; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.velocity[o];
                    for (o = 0,
                    l = 10; o < 4; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.startColor[o];
                    for (o = 0,
                    l = 14; o < 4; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.endColor[o];
                    for (o = 0,
                    l = 18; o < 3; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.sizeRotation[o];
                    for (o = 0,
                    l = 21; o < 2; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.radius[o];
                    for (o = 0,
                    l = 23; o < 4; o++)
                        this._vertices[s + n * this._floatCountPerVertex + l + o] = r.radian[o];
                    this._vertices[s + n * this._floatCountPerVertex + 27] = r.durationAddScale,
    ...
    class m extends s {
        ...
        addNewParticlesToVertexBuffer() {
            ...
            this._firstFreeElement > 0 && (e.setNeedUpload(),
            e.subUpload(0, 0, 4 * this._firstFreeElement * this._floatCountPerVertex * 4))),
            this._firstNewElement = this._firstFreeElement
        }
        renderSubmit() {
            if (this.texture && this.texture.getIsReady()) {
                if (this.update(e.ILaya.timer._delta),
    ...
    class _ extends e.Sprite {
        ...
        customRender(t, e, i) {
            ...
            this._particleTemplate) && (this._particleTemplate.sv.u_mmat = this._matrix4,
    ...
    t.ParticleEmitter = class {
        ...
        update(t, i) {
            if ((t /= 1e3) > 0) {
                e.MathUtil.subtractVector3(i, this._previousPosition, this._tempVelocity),
                e.MathUtil.scaleVector3(this._tempVelocity, 1 / t, this._tempVelocity);
                for (var r = this._timeLeftOver + t, a = -this._timeLeftOver; r > this._timeBetweenParticles; )
                    a += this._timeBetweenParticles,
                    r -= this._timeBetweenParticles,
                    e.MathUtil.lerpVector3(this._previousPosition, i, a / t, this._tempPosition),
